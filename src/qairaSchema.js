export default {
  ...
  "fields": [
    ...
    },
    {
      ...
      "name": "Qaira Story Coverage State",
      "alias": "select",
      "issueTypeKeys": [
        "testCase"
      ],
      ...
      "description": "Whether the test is linked to a Jira Story."
    },
    {
      "key": "stepsCount",
    ...
    },
    {
      ...
      "description": "Percentage of suite Stories covered by tests."
    },
    {
      "key": "suiteHealth",
    ...
    },
    {
      ...
      "name": "Qaira Story Count",
      "alias": "number",
      "issueTypeKeys": [
        "testPlan",
        "qualityGate"
      ],
      "description": "Story count in scope."
    },
    {
      "key": "coveredRequirementCount",
      "name": "Qaira Covered Story Count",
      "alias": "number",
      "issueTypeKeys": [
        "testPlan",
        "qualityGate"
      ],
      "description": "Covered Story count."
    },
    {
    ...
    },
    {
      ...
      "name": "Qaira Critical Story Coverage %",
      "alias": "number",
      "issueTypeKeys": [
        "testPlan",
        "qualityGate"
      ],
      "description": "Critical Story coverage percentage."
    },
    {
    ...
    },
    {
      ...
      "description": "Story-level coverage percentage rollup."
    },
    {
      "key": "reqTestCount",
    ...
    },
    {
      ...
      "name": "Qaira Story Last Run Status",
      "alias": "select",
      "issueTypeKeys": [
        "requirements"
      ],
      ...
      "description": "Latest linked-test status for the Story."
    },
    {
    ...
    },
    {
      ...
      "name": "Qaira Story Stale Test Count",
      "alias": "number",
      "issueTypeKeys": [
        "requirements"
      ],
    ...
    {
      "key": "reqRiskScore",
      "name": "Qaira Story Risk Score",
      "alias": "number",
      "issueTypeKeys": [
        "requirements"
      ],
      "description": "Story risk score."
    },
    {
      ...
      "description": "AI coverage summary on Story issues."
    }
  ],
  "issueProperties": {
    "requirement": "qaira.requirement.v1",
    "testCase": "qaira.testCaseSpec.v1",
    "testCaseSummary": "qaira.testCaseSummary.v1",
  ...
  "reports": [
    {
      ...
      "formula": "100 - 0.25*UncoveredCriticalStoryPct - 0.20*FailedCriticalTestPct - 0.15*OpenBlockerCriticalDefectScore - 0.10*StaleCriticalTestPct - 0.10*FlakyCriticalTestPct - 0.10*AutomationGapPct - 0.05*LocatorInstabilityPct - 0.05*ExecutionSlippagePct"
    },
    {
      "key": "requirementCoverage",
      "name": "Story Coverage %",
      "formula": "Covered Stories / testable Stories * 100"
    },
    {
    ...
    },
    {
      "key": "qaDebt",
      "name": "QA Debt Index",
      "formula": "Weighted stale tests + duplicate tests + flaky tests + unautomated critical tests + unstable locators + uncovered Stories + unreviewed AI suggestions"
    }
  ],
  "agents": [
    "Story Quality Agent",
